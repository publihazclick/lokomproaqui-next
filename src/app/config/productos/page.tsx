...
export default function ProductosPage() {
  ...
  const [modalId, setModalId] = useState<number | null | 'crear' | 'masiva'>(null);
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-1 py-2">
        ...
        {!esAdmin && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-full bg-[#0d6efd] px-4 py-2 text-sm font-bold text-white hover:opacity-90"
          >
            <Layers className="h-4 w-4" /> Carga Masiva de Productos
          </button>
        )}
      </div>
